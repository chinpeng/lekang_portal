...
-- ----------------------------
INSERT INTO `taocaninfo` VALUES ('1', '2', '个人基础普通体检B套餐（男）', '0000001290', '5', '2417', '适用于所有男性', '可对男性身体健康状况做整体评估和疾病筛查。', '一般状况检查,内科,普检,直肠指检,眼压测定等', '肿瘤、心、脑血管、呼吸系统、消化系统、骨及关节疾病', null);
